...
if(isset($_POST['Update'])){
    ...
    // $sql= "update `ussd` set id='$id',campaign='$campaign',
    // shortcode='$shortcode',dbname='$dbname;
    // where id=$id";
...
<div class="popup" id="popup">
        ...
        <form method="post">
            <div class="ussdform-group">
                ...
                <input type="text" class="ussdform-control" 
                placeholder="Campaign"
                name="campaign"  autocomplete="off"
                value="<?php echo $campaign;?>">
            </div>
            ...
            <div class="ussdform-group">
                ...
                <input type="text" class="ussdform-control"
                 ...
                 name="shortcode" autocomplete="off"
            ...
            <div class="ussdform-group">
                <input type="submit" class="ussdform-control"
